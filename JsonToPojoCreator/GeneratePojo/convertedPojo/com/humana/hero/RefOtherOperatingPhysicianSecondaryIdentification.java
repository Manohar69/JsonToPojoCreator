...
public class RefOtherOperatingPhysicianSecondaryIdentification {
    ...
    public RefOtherOperatingPhysicianSecondaryIdentification withRef01OtherOperatingPhysicianSecondaryIdentificationQlfr(String ref01OtherOperatingPhysicianSecondaryIdentificationQlfr) {
        this.ref01OtherOperatingPhysicianSecondaryIdentificationQlfr = ref01OtherOperatingPhysicianSecondaryIdentificationQlfr;
        return this;
    }
    ...
    public RefOtherOperatingPhysicianSecondaryIdentification withRef02OtherOperatingPhysicianSecondaryIdentifier(String ref02OtherOperatingPhysicianSecondaryIdentifier) {
        this.ref02OtherOperatingPhysicianSecondaryIdentifier = ref02OtherOperatingPhysicianSecondaryIdentifier;
        return this;
    }
    ...
    public RefOtherOperatingPhysicianSecondaryIdentification withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RefOtherOperatingPhysicianSecondaryIdentification) == false) {
            return false;
        }
        RefOtherOperatingPhysicianSecondaryIdentification rhs = ((RefOtherOperatingPhysicianSecondaryIdentification) other);
