...
public class K3fileInformation_ {
    ...
    public K3fileInformation_ withK301FileInformation(String k301FileInformation) {
        this.k301FileInformation = k301FileInformation;
        return this;
    }
    ...
    public K3fileInformation_ withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof K3fileInformation_) == false) {
            return false;
        }
        K3fileInformation_ rhs = ((K3fileInformation_) other);
